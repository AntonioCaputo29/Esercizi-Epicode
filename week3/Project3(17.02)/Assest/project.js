...
console.log(deleteOne("Team", true));
console.log(deleteOne("Leader", false));
...
console.log(isThisAnEmail("antocapu29@gmail.com"));
console.log(isThisAnEmail("non è una email"));
...
const birthday = new Date("1994-03-29");
...
const tdInfo = document.querySelectorAll('td');
console.log(tdInfo);
